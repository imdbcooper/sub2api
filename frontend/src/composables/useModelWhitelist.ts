...
const antigravityPresetMappings = [
  ...
  { label: '3.1-Pro-High pass-through', labelKey: 'admin.accounts.modelPresets.antigravity.gemini31ProHighPassThrough', from: 'gemini-3.1-pro-high', to: 'gemini-3.1-pro-high', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' },
  { label: '3.1-Pro-Low pass-through', labelKey: 'admin.accounts.modelPresets.antigravity.gemini31ProLowPassThrough', from: 'gemini-3.1-pro-low', to: 'gemini-3.1-pro-low', color: 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400' },
  // Gemini 通配符映射
  ...
  { label: '2.5-Flash-Image pass-through', labelKey: 'admin.accounts.modelPresets.antigravity.gemini25FlashImagePassThrough', from: 'gemini-2.5-flash-image', to: 'gemini-2.5-flash-image', color: 'bg-sky-100 text-sky-700 hover:bg-sky-200 dark:bg-sky-900/30 dark:text-sky-400' },
  { label: '3.1-Flash-Image pass-through', labelKey: 'admin.accounts.modelPresets.antigravity.gemini31FlashImagePassThrough', from: 'gemini-3.1-flash-image', to: 'gemini-3.1-flash-image', color: 'bg-sky-100 text-sky-700 hover:bg-sky-200 dark:bg-sky-900/30 dark:text-sky-400' },
  ...
  { label: '3-Flash pass-through', labelKey: 'admin.accounts.modelPresets.antigravity.gemini3FlashPassThrough', from: 'gemini-3-flash', to: 'gemini-3-flash', color: 'bg-lime-100 text-lime-700 hover:bg-lime-200 dark:bg-lime-900/30 dark:text-lime-400' },
  { label: '2.5-Flash-Lite pass-through', labelKey: 'admin.accounts.modelPresets.antigravity.gemini25FlashLitePassThrough', from: 'gemini-2.5-flash-lite', to: 'gemini-2.5-flash-lite', color: 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400' },
  // 精确映射
